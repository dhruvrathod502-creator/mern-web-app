        ...
        <div className="max-w-6xl mx-auto md:px-10 px-5 flex flex-col md:flex-row md:items-center md:justify-between">
          ...
          <div className="flex gap-2 items-center mt-4 md:mt-0 flex-wrap">
            ...
            {user?._id === userProfile?._id && (
              <>
                <Button
                  className="bg-[#0866ff] hover:bg-[#0867ffbe] cursor-pointer text-white"
                >
                  <MdDashboard />
                ...
                <Button
                  className="flex gap-2 items-center bg-[#e1e4e8] hover:bg-[#e1e7ef] cursor-pointer dark:bg-[#3a3c3d] text-gray-800 dark:text-gray-200"
                >
                  <Edit />
                ...
                <>
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuTrigger asChild>
                      ...
                      <Button
                        className="bg-[#e1e4e8] hover:bg-[#c0c3c6] dark:bg-[#3a3c3d] dark:text-white text-gray-800 cursor-pointer"
                      >
                        <FaUserCheck />
            ...
            {user?._id !== userProfile?._id &&
              userProfile?.sentRequests?.includes(
                user?._id
              ) && (
