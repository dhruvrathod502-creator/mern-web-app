...
const PostCard = ({ post }) => {
  ...
  const deleteHandler = async () => {
    try {
      const res = await axios.delete(`http://localhost:9000/api/v1/post/${post._id}/delete`, {
        withCredentials: true,
      });
  ...
  return (
    <div className="bg-white dark:bg-[#262829] rounded-xl shadow border border-gray-200 overflow-hidden w-full">
      <div className="flex justify-between items-center px-4 pt-4">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent>
            <DropdownMenuItem onClick={()=>deleteHandler(post._id)}>Delete Post</DropdownMenuItem>

            <DropdownMenuItem onClick={()=>editPostHandler(post)}>Edit Post</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
